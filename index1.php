...
<button onclick="getLocation()">📍 Moja lokacija</button>
<button onclick="enableNotifications()">🔔 Uključi notifikacije</button>
...
function scheduleFajrNotification(){
  ...
  let timeout = fajrDate - now - (10*60*1000);
  if(timeout > 0){
    setTimeout(()=>{
      new Notification("Vrijeme je za Fajr namaz 🕌");
    },timeout);
  }
}
